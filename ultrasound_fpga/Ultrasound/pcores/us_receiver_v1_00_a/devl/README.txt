...
File Summary
  ...
  - HDL source -
  C:\Ultrasound\Ultrasound\pcores\us_receiver_v1_00_a\hdl\vhdl
  top level      : us_receiver.vhd

  - XPS interface -
  C:\Ultrasound\Ultrasound\pcores\us_receiver_v1_00_a\data
  mpd            : us_receiver_v2_1_0.mpd
  pao            : us_receiver_v2_1_0.pao

  - ISE project -
  C:\Ultrasound\Ultrasound\pcores\us_receiver_v1_00_a\devl\projnav
  ise project    : us_receiver.xise
  tcl script     : us_receiver.tcl


  - XST synthesis -
  C:\Ultrasound\Ultrasound\pcores\us_receiver_v1_00_a\devl\synthesis
  xst script     : us_receiver_xst.scr
  xst project    : us_receiver_xst.prj

  - Misc file -
  C:\Ultrasound\Ultrasound\pcores\us_receiver_v1_00_a\devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log

  - Driver source -
  C:\Ultrasound\Ultrasound\drivers\us_receiver_v1_00_a\src
  makefile       : Makefile
  header         : us_receiver.h
  source         : us_receiver.c

  - Driver interface -
  - user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  C:\Ultrasound\Ultrasound\drivers\us_receiver_v1_00_a\data
  mdd            : us_receiver_v2_1_0.mdd
  tcl            : us_receiver_v2_1_0.tcl
...
written into src/us_receiver.c in the Driver Directory.
...
implemented in hdl/vhdl/us_receiver.vhd in the Core Directory.
